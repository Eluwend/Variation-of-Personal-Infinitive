...
correlationmatrixV <-     table(OutcomeBoth$Variety, OutcomeBoth$Outcome)      
  ...
  nrow(Outcome[OutcomeBoth$Pronoun == "nos" & OutcomeBoth$Outcome == "Personal infinitive", ])
  nrow(Outcome[OutcomeBoth$Pronoun == "nos" & OutcomeBoth$Outcome == "Impersonal infinitive", ])
  
  nrow(Outcome[OutcomeBoth$Pronoun == "nos" & OutcomeBoth$Variety == "Brazilian",])
  nrow(Outcome[OutcomeBoth$Pronoun == "nos" & OutcomeBoth$Variety == "European",])
